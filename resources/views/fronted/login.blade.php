...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/portal/images/logo.png')}}">
    ...
    <script src="{{asset('assets/fronted/js/login.js')}}"></script>
</head>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div class="card-img-actions d-inline-block mb-2">
                                <img src="{{asset('assets/portal/images/logo.png')}}" width="120" height="115" alt="">
                            </div>
                        </div>
                        <div class="text-center mb-4">
                            <h6 class="font-weight-semibold mb-0">Halaman Administrator</h6>
                            <span class="d-block text-muted">Yayasan Darul Hikmah Menganti</span>
                        </div>
                        @if(session('msg'))
                            @php($msg = session('msg'))
