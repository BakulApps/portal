                                ...
                                <div class="blog-share-tags">
                                    <div class="blog-share">
                                        ...
                                        <div class="blog-social">
                                            <ul>
                                                <li><a class="whatsapp" href="whatsapp://send?text={{route('article.detail', $post->post_id)}}"><i class="fa fa-whatsapp"></i></a></li>
                                    ...
                                    <div class="blog-tag">
                                        <ul>
                                            ...
                                            <li><a href="{{route('tag', $item->tag_id)}}">{{$item->tag_name}}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="blog-content">
                                            ...
                                            <div class="blog-meta">
                                                <ul>
                                                    ...
                                                    <li><a href="#"><i class="fa fa-comments-o"></i> {{$post_recent->comment->count()}}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="blog-date">
