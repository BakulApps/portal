                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="blog-details-wrap mr-40">
                        <div class="blog-details-top">
                            <img
                                src="{{asset($post->post_image == null ? 'assets/fronted/img/blog/blog-details.jpg' : $post->post_image)}}"
                                alt="">
                                ...
                                <div class="blog-share-tags">
                                    <div class="blog-share">
                                        ...
                                        <div class="blog-social">
                                            <ul>
                                                <li><a class="whatsapp"
                                                       href="whatsapp://send?text={{route('article.detail', $post->post_id)}}"><i
                                    ...
                                    <div class="blog-tag">
                                        <ul>
                                            @foreach($post->tag as $item)
                                                <li><a href="{{route('tag', $item->tag_id)}}">{{$item->tag_name}}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                        ...
                        <div class="blog-author mt-80">
                            <div class="author-img">
                                <img
                                    src="{{asset($post->user->user_image == null ? 'assets/fronted/img/blog/author.jpg' : $post->user->user_image)}}"
                                    alt="">
                            </div>
                            <div class="author-content">
                                <div class="author-content-top">
                                    <div class="blog-designation">
                                        <h5>{{strtoupper($post->user->user_fullname)}}</h5>
                                        <span>Penulis</span>
                                    </div>
