                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="event-left-wrap mr-40">
                        <div class="event-description">
                            <div class="description-date-social mb-45">
                                <div class="description-date-time">
                                    <div class="description-date">
                                        <span
                                            class="event-date">{{\Carbon\Carbon::parse($event->event_date)->formatLocalized('%I')}}</span>
                            ...
                            <img
                                src="{{asset($event->event_image == null ? 'assets/fronted/img/event/event-details.jpg' : $event->event_image)}}"
                                alt="">
