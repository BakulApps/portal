                    ...
                    <div class="blog-all-wrap mr-40">
                                    ...
                                    <div class="single-blog mb-30">
                                        ...
                                        <div class="blog-content-wrap">
                                            ...
                                            <div class="blog-content">
                                                <h4>
                                                    <a href="{{route('article.detail', $post->post_id)}}">{{$post->post_title}}</a>
                                                </h4>
                                                {!! substr($post->post_content, 0, 200) !!}
                                                <div class="blog-meta">
                                                    <ul>
                                                        <li><a href="#"><i
                                                                    class="fa fa-user"></i>{{$post->user->user_name}}
                                                            </a></li>
                                                        <li><a href="#"><i
                                                                    class="fa fa-comments-o"></i> {{$post->comment->count()}}
                                                            </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        @if($posts->lastPage() > 1)
                            <div class="pro-pagination-style text-center mt-25">
                                <ul>
                                    <li><a class="prev" href="{{$posts->url(1)}}"><i
                                                class="fa fa-angle-double-left"></i></a></li>
                                    @for($i=1;$i<$posts->lastPage();$i++)
                                        <li><a class="{{$posts->currentPage() == $i ? 'active' : null}}"
                                               href="{{$posts->url($i)}}">{{$i}}</a></li>
                                    @endfor
                                    <li><a class="next" href="{{$posts->currentPage() + 1}}"><i
