        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-6 col-4">
                    <div class="logo">
                        <a href="{{route('home')}}">
                            <img alt="" src="{{asset($logo)}}" style="width: 200px">
                        </a>
                    </div>
                </div>
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="submenu">
                                            <li><a href="{{route('article.detail', 1)}}">Sejarah Darul Hikmah</a></li>
                                            <li><a href="{{route('article.detail', 2)}}">Visi & Misi</a></li>
                                            <li><a href="{{route('article.detail', 3)}}">Struktur Organisasi</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#"> JENJANG<i class="fa fa-angle-down"></i> </a>
                                        <ul class="submenu">
                                            <li><a target="_blank" href="https://paudra.darul-hikmah.sch.id">PAUD & RA</a></li>
