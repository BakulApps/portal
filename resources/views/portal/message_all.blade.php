...
@endsection
@section('jspage')
    <script src="{{asset('assets/portal/sites/portal/js/message_all.js')}}"></script>
@endsection
@section('breadcrumb')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-white header-elements-inline">
                    <h6 class="card-title font-weight-semibold">DATA PESAN</h6>
                </div>
                <table class="table datatable-message table-bordered">
                    <thead>
                    <tr>
                        <th>NO</th>
                        <th>NAMA</th>
